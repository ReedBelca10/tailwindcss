  ...
  return (
    <main>
      ...
      <div>
        ...
        <p className="text-base">This is a regular paragraph</p>
        <a href="#">This is an ancor</a>
        <div className="my-4">
        ...
        <div>
          <input disabled type="text" placeholder="This is a disabled input"/>
        </div>
        <div>
          <input type="date"/>
        </div>
